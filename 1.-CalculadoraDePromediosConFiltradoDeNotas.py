#Objetivo: Crear una calculadora que pida al usuario una serie de notas y luego 
# calcule el promedio, excluyendo aquellas notas que estén por debajo de un cierto umbral. 
# Este ejercicio te ayudará a practicar el uso de funciones, bifurcaciones, bucles y tipos de datos estructurados.
...
#Deber: Modifica el programa para que, además de calcular el promedio, 
