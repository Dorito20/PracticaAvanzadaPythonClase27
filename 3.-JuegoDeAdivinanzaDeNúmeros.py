#Objetivo: Crear un simple juego de adivinanza donde la computadora elige un número al azar y el usuario debe adivinarlo. 
# Practicarás el uso de funciones, bucles, bifurcaciones y el manejo de variables globales y locales.
...
#Deber: Modifica el juego para que el usuario pueda elegir el rango del número secreto 
# (por ejemplo, entre 1 y 1000) y también cambiar el número máximo de intentos.
