#Objetivo: Crear un pequeño sistema de inventario que permita agregar, eliminar y ver productos en una tienda. 
# Practicarás el uso de funciones, bucles for y while, bifurcaciones simples y dobles, y el manejo de un diccionario.
...
#Deber: Modifica el programa para que permita actualizar la cantidad de 
# un producto existente sin necesidad de agregar uno nuevo.
